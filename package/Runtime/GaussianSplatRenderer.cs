...
namespace GaussianSplatting.Runtime
{
    class GaussianSplatRenderSystem
    {
        ...
        public bool GatherSplatsForCamera(Camera cam)
        {
            ...
            // Detect if we're using single pass stereo rendering
            m_IsSinglePassStereo = XRSettings.enabled && XRSettings.stereoRenderingMode == XRSettings.StereoRenderingMode.SinglePassInstanced;
        ...
        void OnPreCullCamera(Camera cam)
        {
            ...
            m_CommandBuffer.SetGlobalFloat(GaussianSplatRenderer.Props.StereoConvergence, XRSettings.enabled ? 0.05f : 0.0f);
    ...
    public class GaussianSplatRenderer : MonoBehaviour
    {
        ...
        internal void CalcStereoViewData(CommandBuffer cmb, Camera cam)
        {
            ...
            cmb.SetComputeFloatParam(m_CSSplatUtilities, Props.StereoConvergence, XRSettings.enabled ? 0.05f : 0.0f);
